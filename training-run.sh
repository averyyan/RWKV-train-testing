...
GPU_PER_NODE=1 
DS_BUCKET_MB=2 
python3 train.py --load_model "0" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 ...
 --accelerator gpu --devices $GPU_PER_NODE --precision bf16 --strategy deepspeed_stage_1 --grad_cp $GRAD_CP --enable_progress_bar True --ds_bucket_mb $DS_BUCKET_MB
