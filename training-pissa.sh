...
BASE_MODEL="models/RWKV-x060-World-3B-v2.1-20240417-ctx4096.pth"
MODEL_TYPE="x060"
N_LAYER="32"
N_EMBD="2560"
CTX_LEN="4096"
...
PROJ_DIR="out/L"$N_LAYER"-D"$N_EMBD"-"$MODEL_TYPE"-"$CTX_LEN"-pissa"-$QUANT

python3 train.py --load_model $BASE_MODEL --proj_dir $PROJ_DIR --data_file "data/data" \
